...
from config.config import AZURE_STORAGE_ACCOUNT_NAME, AZURE_STORAGE_ACCOUNT_KEY, AZURE_CONTAINER_RAW, ADZUNA_APP_ID, ADZUNA_API_KEY
...
def main():
    ...
    blob_name = f'adzuna_jobs_{today}.json'
